...
```bash
git remote add encore encore://toko-management-system-qwfi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/toko-management-system-qwfi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/toko-management-system-qwfi/settings/integrations/github)
